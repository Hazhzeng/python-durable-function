...
def generator_function(context):
    ...
    task1 = yield context.df.callActivity("DurableFunctionsZActivity", "One")
    logging.warn(f"!!!task1: {task1}")

    task2 = yield context.df.callActivity("DurableFunctionsZActivity", "Two")
    logging.warn(f"!!!task2: {task2}")

    task3 = yield context.df.callActivity("DurableFunctionsZActivity", "Three")
